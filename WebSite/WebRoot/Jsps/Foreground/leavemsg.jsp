...
<html>
  <head>
    ...
    <title>My JSP 'leavemsg.jsp' starting page</title>
	...
	<script type="text/javascript">
		...
		function lmsg(){
			var txt = $("#lmsg").val();
			var who = $("#who").val();
			var url = "foreAction!saveLeaveMsg.action?messages.content=" + txt + "&messages.disname=" + who;
			alert(url);
			$.ajax({ 
	  			type:"post",              //提交方式
  ...
  <div style="width:250; height:100; margin: 0 8">
  	<textarea id="lmsg" rows="5" cols="20" name="messages.content"></textarea><br/>
