...
<html>
  <head>
    ...
    <title>Photo Desk</title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
		<meta name="description" content="" />
		<meta name="keywords" content=""/>
		<link rel="shortcut icon" href="../favicon.ico" type="image/x-icon"/>
		<link rel="stylesheet" href="css/style_photodesk.css" type="text/css" media="screen"/>
		<!-- The JavaScript -->
		...
		function loaddesk(){
			var div0 = "<div class='pd_photo'>";
			var div1 = "<div class='pd_hold'>";
			var img0 = "<img src='";
			var img_ = "'/>";
			var div_ = "</div>";
			...
			$.ajax({ 
	  			type:"post",              //提交方式
	  			url:"foreAction!loadFreedom.action",  //要跳转到的action
	  			cache:false,
	  			...
	  			success:function(msg) //当ajax请求成功后显示的消息  msg为ajax返回的所有信息
	  			{
	  				...
	  				var content = "";
		  			  for(var i = 0; i < messages.length; i++){
		  				  content += div0 + div1 + img0 + messages[i].filepath 
		  				  + img_ + div_ + span + div_;
		  				  //$("#pd_container").after(content);
		  			  }	
		  			  //alert(content);
	  			  	 $("#pd_container").after(content);
  ...
  <body>
		<div>
			...
			<span class="reference">
				<!-- <a href="http://tympanus.net/codrops/2010/07/01/interactive-photo-desk">© Codrops</a> -->
			</span>
		</div>
		...
		<div id="pd_container" class="pd_container">
			<s:iterator id="pd_list" value="listFiles">
				<div class="pd_photo">
				<div class="pd_hold">
					<img src="<s:property value="#pd_list.filepath"/>" alt=""/>
				</div>
